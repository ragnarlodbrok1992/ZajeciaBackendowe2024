    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='viewer.accounttype')),
                ('user_permissions', models.ManyToManyField(to='viewer.custompermissions')),
            ],
            options={
                'verbose_name': 'user',
